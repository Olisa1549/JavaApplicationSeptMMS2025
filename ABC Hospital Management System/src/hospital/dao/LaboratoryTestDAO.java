...
public class LaboratoryTestDAO {
    ...
    public void addLaboratoryTest(LaboratoryTest test) {
        String sql = """
            ...
            (PatientId, TechnicianStaffId, TestName, TestDate,
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            int technicianId = test.getTechnician().getStaffID();
    ...
    public List<LaboratoryTest> findAllLaboratoryTests() {
        ...
        String sql = """
            SELECT LaboratoryTestId, PatientId, TechnicianStaffId,
    ...
    public List<LaboratoryTest> findLaboratoryTestsByTechnician(int staffId) {
        ...
        String sql = """
            ...
            INNER JOIN LaboratoryTechnician ltech
                ON lt.TechnicianStaffId = ltech.StaffId
            WHERE ltech.StaffId = ?
    ...
    private LaboratoryTest mapLaboratoryTest(
        ...
        technician.setStaffID(rs.getInt("TechnicianStaffId"));
    ...
    // =========================================================
    private int getTechnicianStaffIdByStaffId(
            Connection conn,
