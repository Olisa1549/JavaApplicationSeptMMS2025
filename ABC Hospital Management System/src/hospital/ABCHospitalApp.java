...
public class ABCHospitalApp {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 0:
                    ...
                    System.out.println("Thank you for using LifeSaver Hospital Management System.");
                    scanner.close();
                    return;
    ...
    private static User login() {
        ...
        System.out.println();
        System.out.println("========================================");
        System.out.println("          LIFESAVER HOSPITAL SYSTEM");
    ...
    private static void displayMainMenu() {
        ...
        System.out.println();
        System.out.println("========================================");
        System.out.println("       LIFESAVER HOSPITAL MANAGEMENT SYSTEM");
        System.out.println("========================================");
        System.out.println();
...
// ============================================================
// Handles hospital staff login accounts.
//
// Operations:
// 1. Create Staff Account
// 2. View All Staff Accounts
// 3. Find Staff Account
// 4. Update Staff Account
...
//
// NOTE:
// PasswordHash currently stores the development password value.
// Proper password hashing can be added later as a security
// improvement.
// ============================================================
    private static void staffAccountManagementMenu() {
        ...
        while (true) {
            ...
            System.out.println("3. Find Staff Account");
            System.out.println("4. Update Staff Account");
...
// ============================================================
// Creates a new login account and optionally connects it to
// an existing Staff record.
// ============================================================
    private static void createStaffAccount() {
        ...
        System.out.println("5. PHARMACIST");
        System.out.println("6. LABORATORY_TECHNICIAN");
        ...
        int staffId
                = readInt("Staff ID (enter 0 if not linked): ");

        Integer linkedStaffId
                = staffId == 0 ? null : staffId;
...
// ============================================================
// Displays every account stored in the Users table.
// ============================================================
    private static void viewAllStaffAccounts() {
        ...
        try (
            ...
            System.out.println(
                    "Error retrieving staff accounts."
            );
...
// FIND STAFF ACCOUNT
// ============================================================
// Searches for a user account using User ID.
// ============================================================
    private static void findStaffAccount() {

        System.out.println();
        System.out.println("========================================");
        System.out.println("          FIND STAFF ACCOUNT");
        System.out.println("========================================");
...
// ============================================================
// Updates username, password, role and linked Staff ID.
// ============================================================
    private static void updateStaffAccount() {

        System.out.println();
        System.out.println("========================================");
        System.out.println("         UPDATE STAFF ACCOUNT");
        System.out.println("========================================");
        ...
        String username
                = readString("New Username: ");

        String password
                = readString("New Password: ");
        ...
        int staffId
                = readInt("New Staff ID (0 for none): ");
...
// ============================================================
    private static void toggleStaffAccountStatus() {
...
// ============================================================
// Permanently removes a user account from the Users table.
// This does NOT delete the associated Staff record.
// ============================================================
    private static void deleteStaffAccount() {

        System.out.println();
        System.out.println("========================================");
        System.out.println("          DELETE STAFF ACCOUNT");
        System.out.println("========================================");
 ...
 * ============================================================
 *
 * This is the main menu for all clinical-related operations.
 *
...
// =========================================================
    ...
    // LABORATORY SERVICES
    // =========================================================
    private static void laboratoryServicesMenu() {
        showModuleStatus("LABORATORY SERVICES",
                "Laboratory Services is now a top-level hospital service.",
                "The LaboratoryTest table is already part of the database and can be connected here next.");
    }

    // =========================================================
    // PHARMACY SERVICES
    // =========================================================
    private static void pharmacyServicesMenu() {
        showModuleStatus("PHARMACY SERVICES",
                "Pharmacy Services is now a top-level hospital service.",
                "Medication, prescription and dispensing workflows can be connected here next.");
    }

    // =========================================================
    // BILLING & PAYMENT
    // =========================================================
    private static void billingPaymentMenu() {
        showModuleStatus("BILLING & PAYMENT",
                "Billing & Payment is now a top-level hospital service.",
                "Invoice, invoice item and payment workflows can be connected here next.");
    }
